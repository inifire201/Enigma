...
//Enigma code
    ...
    int rotorIV  [26] = {5 ,19,15,22,16,26,10,1 ,25,17,21,9 ,18,8 ,24,12,14,6 ,20,7 ,11,4 ,3 ,13,23,2 };
    int rotorV   [26] = {22,26,2 ,18,7 ,9 ,20,25,21,16,19,4 ,14,8 ,12,24,1 ,23,13,10,17,15,6 ,5 ,3 ,11};
    int rotorVI  [26] = {10,16,7 ,22,15,21,13,6 ,25,17,2 ,5 ,14,8 ,26,18,4 ,11,1 ,19,24,X 	L 	I	C 	T 	W}
